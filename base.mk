...
ccsrctoobj = $(patsubst $(SRCDIR)/%.cc,$(OBJDIR)/%.o,$(filter-out $(OBJDIR)/%,$(1)))
...
CXX = $(HPGMG_CXX)
CCLD = $(if $(PCC_LINKER),$(PCC_LINKER),$(HPGMG_CXX))
CFLAGS += -I$(CUDA_DIR)/include
HPGMG_COMPILE.c = $(call quiet,CC) -c $(C99FLAGS) $(HPGMG_CPPFLAGS) $(CPPFLAGS) $(HPGMG_CFLAGS) $(CFLAGS) $(C_DEPFLAGS)
HPGMG_COMPILE.cc = $(call quiet,CXX) -c $(HPGMG_CPPFLAGS) $(CPPFLAGS) $(HPGMG_CXXFLAGS) $(CFLAGS) $(C_DEPFLAGS)
...
hpgmg-fv-y.cc.o := $(call ccsrctoobj,$(hpgmg-fv-y.cc))
...
$(hpgmg-fv-y.cc.o) : CPPFLAGS += $(CONFIG_FV_CPPFLAGS)
$(hpgmg-fv-y.cu.o.dlink) : CPPFLAGS += $(CONFIG_FV_CPPFLAGS)
$(hpgmg-fv) : $(hpgmg-fv-y.o) $(hpgmg-fv-y.cc.o) $(hpgmg-fv-y.cu.o) $(hpgmg-fv-y.cu.o.dlink) | $$(@D)/.DIR
...
$(OBJDIR)/%a.o: $(OBJDIR)/%.cc
	$(HPGMG_COMPILE.cc) $< -o $@

$(OBJDIR)/%.o: $(SRCDIR)/%.c | $$(@D)/.DIR
	$(HPGMG_COMPILE.c) $< -o $@

$(OBJDIR)/%.o: $(SRCDIR)/%.cc | $$(@D)/.DIR
	$(HPGMG_COMPILE.cc) $< -o $@
...
$(OBJDIR)/%.cu.o.dlink: $(OBJDIR)/%.cu.o | $$(@D)/.DIR
	nvcc -dlink $< $(HPGMG_CUDA_ARCH) -o $@ $(HPGMG_LDFLAGS) $(HPGMG_LDLIBS)
...
srcs.cc := $(hpgmg-fv-y.cc)
srcs.o := $(call srctoobj,$(srcs.c)) $(call ccsrctoobj,$(srcs.cc))
srcs.d := $(srcs.o:%.o=%.d)
