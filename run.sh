...
$MPI_HOME/bin/mpirun -verbose  $OMPI_params   \
	-x GDS_CQ_MAP_SMART=0 -x GDS_ENABLE_DEBUG=0 \
	-x MP_ENABLE_DEBUG=0 -x HPGMG_ENABLE_DEBUG=0 \
	-x MP_EVENT_ASYNC=0 -x MP_ENABLE_WARN \
	...
	-x COMM_USE_COMM=$2  -x COMM_USE_ASYNC_SA=$3   -x COMM_USE_ASYNC_KI=$4 \
