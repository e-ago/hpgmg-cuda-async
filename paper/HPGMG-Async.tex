...
To avoid the UVM issues, we tested asynchronous communications using an HPGMG similar stencil-code described in \cite{paper 2dstencil}.
...
In Figure \ref{fig:gain_2dstencil_2proc_ivy} there is the gain of asynchronous modes on MPI in case of 2 nodes on the 2U Xeon servers and in Figure \ref{} the gain in case of 16 nodes on Wilkes. 
