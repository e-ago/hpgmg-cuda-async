...
Therefore, in a multi-GPU execution the smoother must exchange the boundary regions with the other processes (\emph{intra-level} communication). 
...
\caption{HPGMG-FV, 2 processes, Asynchronous time gain over default MPI communications, 2U Xeon Servers}
\label{fig:gain_ivy}
\end{figure}
