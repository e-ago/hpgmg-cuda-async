...
there is the gain in both SA and KI models considering communication times only. To obtain this measure we used a cudaDeviceSynchronize() before and after every exchange boundaries function calls; this behaviour limited the benefits os asynchronous communications, because \\
